...
<body>
        ...
        <?php
/*Formulario para crear un usuario y contraseña en vuestra 
base de datos.


Añadir el nuevo usuario y contraseña a la base de datos.


Una vez introducido que aparezca una pantalla diciendo que lo 
has introducido 
bien y un botón de ir para atrás. */
